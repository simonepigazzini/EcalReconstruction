...
# with command line options: reRECO --conditions 74X_dataRun2_Prompt_v4 -s RAW2DIGI,L1Reco,RECO,PAT --runUnscheduled --data --eventcontent MINIAOD --scenario pp --datatier MINIAOD --customise Configuration/DataProcessing/RecoTLR.customiseDataRun2Common_25ns --filein /store/data/Run2015C/SingleElectron/RAW/v1/000/254/879/00000/8E51CA98-7349-E511-B9AE-02163E01427B.root -n 100 --no_exec --python_filename=RECO_Run2015D.py
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('/store/data/Run2015C/SingleElectron/RAW/v1/000/254/879/00000/8E51CA98-7349-E511-B9AE-02163E01427B.root'),
...
process.MINIAODoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('reRECO_RAW2DIGI_L1Reco_RECO_PAT.root'),
