...
#file name
fileList = 'AlCaPhiSym_Run2016H_runs281207_284035.list'
if not( os.path.isfile(fileList) ):
   print "WARNING!!! " + str(fileList) + " not found!"
fileJson = '/afs/cern.ch/cms/CAF/CMSCOMM/COMM_DQM/certification/Collisions16/13TeV/ReReco/Cert_271036-284044_13TeV_23Sep2016ReReco_Collisions16_JSON.txt'
if not( os.path.isfile(fileJson) ):
   print "WARNING!!! " + str(fileJson) + " not found!"
fileNEW = 'AlCaPhiSym_Run2016H_runs281207_284035_Pure.list'
