...
# === Run 2016 ===
conddb_import -f sqlite_file:/afs/cern.ch/work/e/emanuele/ecal/ecalreco/multifit/studies_25ns/CMSSW_8_0_5/src/EcalReconstruction/dbscripts/ecaltemplates_popcon_runs_271983_272818.db -i EcalPulseShapes_data -c sqlite_file:ecaltemplates_popcon_weekly_best.db -t EcalPulseShapes_data -b 271983
conddb_import -f sqlite_file:/afs/cern.ch/work/e/emanuele/ecal/ecalreco/multifit/studies_25ns/CMSSW_8_0_5/src/EcalReconstruction/dbscripts/ecaltemplates_popcon_runs_273301_273590.db -i EcalPulseShapes_data -c sqlite_file:ecaltemplates_popcon_weekly_best.db -t EcalPulseShapes_data -b 272818
